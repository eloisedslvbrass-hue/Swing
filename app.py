...
BRANDS = [
    {"designer": "Dior", "query": "", "price_from": 0},
    {"designer": "Balmain", "query": "", "price_from": 0},
    {"designer": "Saint Laurent Paris", "query": "", "price_from": 0},
]
...
def fetch_brand(brand_cfg: dict):
    ...
    price_from = brand_cfg.get("price_from", 0)
